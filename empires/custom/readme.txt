...
For example, you might have the following file structure:
	...
	empires/custom/my_custom_stuff/   <<< This subfolder will be added as a search custom
	empires/custom/my_custom_stuff/models/custom_model.mdl
	empires/custom/my_custom_stuff/materials/custom_material.vmt
	empires/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	empires/custom/some_mod.vpk       <<< This VPK will be added as a search custom
	empires/custom/another_mod.vpk    <<< This VPK will be added as a search custom
...
Note that the following directory structure is NOT correct:
	...
	empires/custom/models/my_model.mdl
